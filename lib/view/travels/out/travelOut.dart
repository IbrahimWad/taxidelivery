...
class Travelout extends StatelessWidget {
  const Travelout({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<OutTravelController>(builder: (controller) {
      return Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Positioned(
                ...
                child: CustomButton(
                  onPressed: () {
                    controller.whereToGoOut(context);
                  },
                  text: 'تاكيد وجهتك',
                ))
          ],
